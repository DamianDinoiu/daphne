...
#ifndef SRC_IR_DAPHNEIR_DAPHNEINFERUNIQUEOPINTERFACE_H
#define SRC_IR_DAPHNEIR_DAPHNEINFERUNIQUEOPINTERFACE_H
...
class UniqueIfArg : public TraitBase<ConcreteOp, UniqueIfArg> {};
...
#include <ir/daphneir/DaphneInferUniqueOpInterface.h.inc>
}
...
namespace mlir::daphne {
bool tryInferUnique(mlir::Operation* op);
}

#endif //SRC_IR_DAPHNEIR_DAPHNEINFERUNIQUEOPINTERFACE_H